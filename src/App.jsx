...
import {
  ...
  GraduationCap, Heart, Smartphone, Menu, X, Copy, ExternalLink,
    ...
    <nav className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${scrolled ? 'border-b border-[#D4AF37]/20 bg-[#07111f]/90 shadow-2xl shadow-black/20 backdrop-blur-xl' : 'bg-transparent'}`}>
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:h-20 lg:px-8">
        <a href="#top" className="flex min-w-0 items-center gap-2 sm:gap-3" onClick={close}>
          <img src={LOGO} alt="BVT Token" className="h-9 w-9 rounded-full object-contain sm:h-11 sm:w-11" />
  ...
  return (
    <footer className="border-t border-[#D4AF37]/10 py-8">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 text-center sm:px-6 md:flex-row md:text-left">
        <div className="flex items-center gap-3">
          <img src={LOGO} alt="BVT Token" className="h-9 w-9 rounded-full object-contain" />
...
export default function App() {
  return (
       <div className="min-h-screen overflow-x-hidden bg-[#020B2D] text-white selection:bg-[#0066FF]/30">
      <Navbar />
      <main>
        <Hero />
        <PresaleStatus />
